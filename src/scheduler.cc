...
void start_scheduler_service(const char* server_addr) {
  std::string server_address(server_addr);
  std::string::iterator split_point = split_ip_address(server_address);
  std::string port;
  port.assign(split_point, server_address.end());
