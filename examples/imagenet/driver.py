...
parser.add_argument("--label-file", default="train.txt", type=str, help="File that contains image labels")
...
if __name__ == "__main__":
  ...
  x, _ = imagenet.load_tarfiles_from_s3(args.s3_bucket, map(str, images), [256, 256]) # TODO(pcm): implement unicode serialization
